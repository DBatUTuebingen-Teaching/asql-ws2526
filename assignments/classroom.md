...
3. **Register on [Discord](https://discord.com).** We will use a [Discord Server](https://db.cs.uni-tuebingen.de/discord) (https://db.cs.uni-tuebingen.de/discord) for communication and discussion of lecture content, as well as for the organization of the exercises. Therefore, registration on our Discord Server is **not** optional.

4. Checkout the [`#announcements`](https://discord.com/channels/756089411288039477/1417468746993504307) channel on Discord. There you will find the link to the registration for the exercises. Join an existing team or create a new one.
...
5. Once you have joined or created a team, there will be a repository created for your team on `github` (in the `DBatUTuebingen-Teaching` organization). This repository is private and only accessible to the members of your team:
  https://github.com/DBatUTuebingen-Teaching/⟨lecture⟩-assignments-⟨YourTeam⟩

6. **Clone the repository.**
  ```bash
  git clone git@github.com:DBatUTuebingen-Teaching/⟨lecture⟩-assignments-⟨YourTeam⟩.git
  ```
